...
object AboutText {
    const val ENGLISH: String =
        ...
        "Privacy by architecture, not privacy by promise."
    ...
    private val byLanguage: Map<Language, String> = mapOf(
        ...
        Language.ITALIAN to
            ...
            "Privacy tramite architettura, non tramite promessa.",
        ...
        Language.HINDI to
            ...
            "यह वादे से नहीं, बल्कि आर्किटेक्चर से गोपनीयता है।",
        ...
        Language.ARABIC to
            ...
            "خصوصية بالهندسة المعمارية، وليست خصوصية بالوعد.",
        ...
        Language.RUSSIAN to
            ...
            "Приватность за счёт архитектуры, а не за счёт обещаний.",
        ...
        Language.VIETNAMESE to
            ...
            "Quyền riêng tư theo kiến trúc, không phải theo lời hứa."
    )
